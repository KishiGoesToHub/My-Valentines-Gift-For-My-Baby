...
const message = "Every second by your side is a memory I would like to keep forever. Thank you for being my quiet peace, my loudest joy, and my entire world. I am so thankful to God for giving you to me my pretty, caring, kind, smart and hardworking baby. I promise to love you even more today than yesterday. You are the greatest gift life has ever given me, and I am so lucky to call you mine. No matter where life takes us, my heart will always find its way back to you. Even if we argue I know God will always guide us to each other with an invisible thread because you are my other half. You are my beginning, my ending, and my forever.";
let index = 0;
let hasTyped = false;
